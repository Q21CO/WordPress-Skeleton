...
function process_odlinksutilities(){
  ...
  switch ($_GET["odlinks_admin_action"]){
    ...
    case "uninstall":
      ...
      $msg .= '<h3><strong><a href='.$deactivate_url.'>Click Here</a> to finish the uninstallation and "ODLinks" will be deactivated automatically.</strong></h3>';
      $exit = TRUE;
    break;
  }
  if ($msg!=''){
...
//-->
  ...
  <div class="wrap">
    <div id="id2" class="postbox" style="display: block">
      <h3 class="hndle">Uninstall</h3>
      <div class="inside">
        <p>Just make sure you create backups before you drops the Open Directory Links Database tables.</p>
        <P><b>PLEASE NOTE: </b>To remove ODLinks you should deactivate it.<br />
